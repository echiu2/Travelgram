...
const sync = async () => {
  ...
  try {
    ...
    // brandon.addFriend(kalvin)
    kalvin.addFriend(brandon)
    // brandon.addFriend(edwin)
    // edwin.addFriend(brandon)

    // FriendRequest.create({ sender: edwin.id, reciever: kalvin.id })
    // FriendRequest.create({ sender: kalvin.id, reciever: brandon.id })

    kalvin.addFriendRequest(brandon)
    kalvin.addFriendRequest(edwin)
    edwin.addFriendRequest(kalvin)
